...
namespace Model
{
	...
	AbstractSensor::AbstractSensor() :
								agent( nullptr),
								running( false),stddev(0)
	{
	}
	/**
	 *
	 */
	AbstractSensor::AbstractSensor( AbstractAgent* anAgent,double stddev) :
								agent( anAgent),
								running( false),stddev(stddev)
	{
	 ...
	 * 
	 */
	double AbstractSensor::getStdDev() const
	{
		return stddev;
	} 
} // namespace Model
