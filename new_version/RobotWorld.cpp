...
namespace Model
{
	...
	void RobotWorld::populate( int aNumberOfWalls /*= 2*/)
	{
		...
		static Point coordinates[] = { Point( 5, 400), Point( 350, 300),
									   Point( 491, 0), Point( 491, 250),
									   Point( 474, 480), Point( 850, 274),
									   Point( 418, 680), Point( 900, 800),
									   Point( 0, 0), Point( 1024,0),
									   Point( 0, 0), Point( 0, 1024),
									   Point( 1024, 0), Point( 1024, 1024),
									   Point( 0, 1024), Point( 1024, 1024)
									   };
		...
		RobotWorld::getRobotWorld().newGoal( "Goal", Point(637,590),false);
