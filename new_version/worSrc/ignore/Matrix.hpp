...
class Matrix
{
	public:
		...
		*/
		...
		/**
		 * returns a 2 by 3 jacobi matrix
		 */

		Matrix<T, 2, 3> makeJacobi(std::vector<double> lengtes,std::vector<double> theta) const;

		Matrix<T, 3, 2> makeJacobiInverse(std::vector<double> lengtes,std::vector<double> theta) const;
