...
namespace Application
{
	...
	class MainFrameWindow : public Frame
	{
		...
		private:
			...
			void OnStartRobotParticle( CommandEvent& anEvent);
			void OnStartRobotKalman( CommandEvent& anEvent);
			void OnStartRobotBothParticle( CommandEvent& anEvent);
			void OnStartRobotBothKalman( CommandEvent& anEvent);
